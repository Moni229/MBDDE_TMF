...
class DeltaWriter:
    ...
    def write(
        ...
        if run_mode == RUN_MODE_AVAILABLE_NOW:
            ...
            print(f"Query '{query_name}' started in 'availableNow' mode. Waiting for completion... {datetime.now()}")
            query.awaitTermination()
            print(f"Query '{query_name}' completed in 'availableNow' mode... {datetime.now()}")
